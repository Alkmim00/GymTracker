...
class _AddExerciseScreenState extends State<AddExerciseScreen> {
  ...
  void initState() {
    super.initState();
    syncAndLoadCustomExercises();
  }

  Future<void> syncAndLoadCustomExercises() async {
    await ExerciseService.syncCustomExercises();
    loadCustomExercises();
  }
          ...
          actions: [
            ...
            TextButton(
              onPressed: () async {
                ...
                var exercise = box.values.firstWhere(
                  (item) => item.name == name,
                );

                exercise.isDeleted = true;
                await exercise.save();
                await ExerciseService.updateCustomExercise(exercise);
  ...
  Widget build(BuildContext context) {
    final defaultExercises = exerciseLibrary[widget.muscleGroup] ?? [];
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...allExercises.map(
            (exercise) {
              bool isCustom = customExercises.contains(exercise);
